...
Netflix - Watch TV Shows Online, Watch Movies Online"
      ...
      <div className=" bg-goli  ">
        <div>
          <div
            className=" w-full  min-h-[200px] sm:min-h-[200px]   md:min-h-[200px] lg:min-h-[200px] bg-cover bg-top sm:bg-cover sm:bg-top md:bg-cover md:bg-top lg:bg-cover lg:bg-top  "
